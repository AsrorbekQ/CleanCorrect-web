  ...
  const content = {
    uz: {
      ...
      hero: {
        ...
        subtitle: "Shaffof elaynerlar bilan tish tekislash - qulay va samarali davolash usuli",
        cta: "Maslahat olish"
      },
      advantages: {
      ...
      mission: {
        title: "Maqsadimiz",
        description: "Odamlarga tekis va chiroyli tishlar ulashish. Elayner bilan tish tekislash xizmatlarini sifatli va maqbul narxda amalga oshiramiz."
      },
      process: {
        title: "Bizning ish jarayonimiz"
      },
      results: {
        title: "Elaynerlar bilan erishilgan natijalar - Tish Tekislash",
        before: "Avval",
        after: "Keyin"
      },
      services: {
        ...
        patients: {
          ...
          items: [
            "Elayner va breketlar bilan tish tekislash",
      ...
      why: {
        ...
        details: "Deformatsiyaga chidamli, tishlarga ortiqcha bosim bermaydi. Breket tizimidagi nikel-titan sim kabi – yumshoq va uzoq vaqt davomida mo'tadil kuch bilan ishlaydi. O'zbekiston bo'ylab eng sifatli elayner xizmatlari."
      },
      contact: {
        title: "Bog'lanish",
    ...
    ru: {
      ...
      hero: {
        ...
        subtitle: "Прозрачные элайнеры для выравнивания зубов - удобный и эффективный метод лечения",
